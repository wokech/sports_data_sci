...
team_order <- sa_pl_merge_bar_24_25_pt_gd %>%
...
sa_pl_merge_bar_24_25_pt_gd_long %>%
...
sa_pl_merge_24_25_non_perc <- sa_pl_merge_24_25 |>
  mutate(
    PPG = P / GP,
    GPG = F / GP,
    GAPG = A / GP,
...
sa_pl_merge_24_25_perc <- sa_pl_merge_24_25 |>
  mutate(
    WinPerc = (W / GP) * 100,
    DrawPerc = (D / GP) * 100,
    LossPerc = (L / GP) * 100,
...
sa_pl_merge_24_25_non_perc_radar <- sa_pl_merge_24_25_non_perc |>
  select(team_name, PPG, GPG, GAPG, GF2GA, GDPG, GD2P) 

sa_pl_merge_24_25_perc_radar <- sa_pl_merge_24_25_perc |>
...
sa_pl_merge_24_25_perc_radar_top_3 <- sa_pl_merge_24_25_perc_radar |>
...
perc_radar_top_3 <- ggradar(sa_pl_merge_24_25_perc_radar_top_3,
                            grid.min = 0,
                            grid.mid = 50,
                            grid.max = 100,
                            values.radar = c("", "", ""),
...
ggsave("sub_pro_4_sa_pl_analysis/images/24_25/sa_pl_analysis_24_25_perc_radar_top_3.png", height = 12, width = 12, dpi = 300)


# Bottom 3 Teams (Percent Metrics)

sa_pl_merge_24_25_perc_radar_bottom_3 <- sa_pl_merge_24_25_perc_radar |>
...
perc_radar_bottom_3 <- ggradar(sa_pl_merge_24_25_perc_radar_bottom_3,
                               grid.min = 0,
                               grid.mid = 50,
                               grid.max = 100,
                               values.radar = c("", "", ""),
...
ggsave("sub_pro_4_sa_pl_analysis/images/24_25/sa_pl_analysis_24_25_perc_radar_bottom_3.png", height = 12, width = 12, dpi = 300)


# Bottom 3 Teams (Percent Metrics)

sa_pl_merge_24_25_perc_radar_top_bottom_2 <- sa_pl_merge_24_25_perc_radar |>
...
perc_radar_top_bottom_2 <- ggradar(sa_pl_merge_24_25_perc_radar_top_bottom_2,
                                   grid.min = 0,
                                   grid.mid = 50,
                                   grid.max = 100,
                                   values.radar = c("", "", ""),
...
ggsave("sub_pro_4_sa_pl_analysis/images/24_25/sa_pl_analysis_24_25_perc_radar_top_bottom_2.png", height = 12, width = 12, dpi = 300)
