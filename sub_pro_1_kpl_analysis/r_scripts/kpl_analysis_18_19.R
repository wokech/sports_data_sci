...
team_order <- kpl_merge_bar_18_19_pt_gd %>%
...
kpl_merge_bar_18_19_pt_gd_long %>%
...
kpl_merge_18_19_non_perc <- kpl_merge_18_19 |>
  mutate(
    PPG = P / GP,
    GPG = F / GP,
    GAPG = A / GP,
...
kpl_merge_18_19_perc <- kpl_merge_18_19 |>
  mutate(
    WinPerc = (W / GP) * 100,
    DrawPerc = (D / GP) * 100,
    LossPerc = (L / GP) * 100,
...
kpl_merge_18_19_non_perc_radar <- kpl_merge_18_19_non_perc |>
  select(team_name, PPG, GPG, GAPG, GF2GA, GDPG, GD2P) 

kpl_merge_18_19_perc_radar <- kpl_merge_18_19_perc |>
...
kpl_merge_18_19_perc_radar_top_3 <- kpl_merge_18_19_perc_radar |>
  filter(team_name == c("Gor Mahia", "Bandari", "Sofapaka"))

my_top_colors <- c("Gor Mahia" = "#BE8125", 
                   "Bandari" = "#2FBE25", 
                   "Sofapaka" = "#BE25AB")

perc_radar_top_3 <- ggradar(kpl_merge_18_19_perc_radar_top_3,
                            grid.min = 0,
                            grid.mid = 50,
                            grid.max = 100,
                            values.radar = c("", "", ""),
...
ggsave("sub_pro_1_kpl_analysis/images/18_19/kpl_analysis_18_19_perc_radar_top_3.png", height = 12, width = 12, dpi = 300)


# Bottom 3 Teams (Percent Metrics)

kpl_merge_18_19_perc_radar_bottom_3 <- kpl_merge_18_19_perc_radar |>
  filter(team_name == c("Posta Rangers", "Vihiga United", "Mt. Kenya United"))

my_bottom_colors <- c("Posta Rangers" = "#BE8125", 
                      "Vihiga United" = "#2FBE25", 
                      "Mt. Kenya United" = "#BE25AB")

perc_radar_bottom_3 <- ggradar(kpl_merge_18_19_perc_radar_bottom_3,
                               grid.min = 0,
                               grid.mid = 50,
                               grid.max = 100,
                               values.radar = c("", "", ""),
...
ggsave("sub_pro_1_kpl_analysis/images/18_19/kpl_analysis_18_19_perc_radar_bottom_3.png", height = 12, width = 12, dpi = 300)


# Top Bottom 2 Teams (Percent Metrics)

kpl_merge_18_19_perc_radar_top_bottom_2 <- kpl_merge_18_19_perc_radar |>
  filter(team_name %in% c("Gor Mahia", "Bandari", "Vihiga United", "Mt. Kenya United"))
...
perc_radar_top_bottom_2 <- ggradar(kpl_merge_18_19_perc_radar_top_bottom_2,
                                   grid.min = 0,
                                   grid.mid = 50,
                                   grid.max = 100,
                                   values.radar = c("", "", ""),
...
ggsave("sub_pro_1_kpl_analysis/images/18_19/kpl_analysis_18_19_perc_radar_top_bottom_2.png", height = 12, width = 12, dpi = 300)
