...
kpl_merge_bar_22_23_pt_gd_long <- kpl_merge_bar_22_23_pt_gd %>%
  ...
  mutate(team_name = fct_reorder(team_name, kpl_merge_bar_22_23_pt_gd$P[match(team_name, kpl_merge_bar_22_23_pt_gd$team_name)]))

# Plot
ggplot(kpl_merge_bar_22_23_pt_gd_long, aes(x = team_name, y = value, fill = metric)) +
