...
kpl_merge_lollipop_17_18_pt_gd <- kpl_merge_17_18 |>
...
kpl_merge_lollipop_17_18_pt_gd_long <- kpl_merge_lollipop_17_18_pt_gd %>%
  pivot_longer(cols = c(P, GD), names_to = "metric", values_to = "value") |>
  mutate(team_name = fct_reorder(team_name, kpl_merge_lollipop_17_18_pt_gd$P[match(team_name, kpl_merge_lollipop_17_18_pt_gd$team_name)]))

# Plot
ggplot(kpl_merge_lollipop_17_18_pt_gd_long, aes(x = team_name, y = value, fill = metric)) +
  geom_col(position = "dodge") +
  geom_text(data = kpl_merge_lollipop_17_18_pt_gd,
...
ggsave("r_scripts/kpl_analysis/kpl_analysis_17_18_pt_gd.png", width = 12, height = 12, dpi = 300)
...
ggsave("r_scripts/kpl_analysis/kpl_analysis_17_18_w_l.png", width = 12, height = 12, dpi = 300)
